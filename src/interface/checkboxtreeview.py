...
IM_CHECKED = os.path.join("assets", "box", "checked.png")
IM_UNCHECKED = os.path.join("assets", "box", "unchecked.png")
IM_TRISTATE = os.path.join("assets", "box", "tristate.png")
...
class CheckboxTreeview(ttk.Treeview):
    ...
    def __init__(self, master=None, **kw):
        ...
        self.im_checked = ImageTk.PhotoImage(Image.open(IM_CHECKED).resize((15, 15)), master=self)
        self.im_unchecked = ImageTk.PhotoImage(Image.open(IM_UNCHECKED).resize((15, 15)), master=self)
        self.im_tristate = ImageTk.PhotoImage(Image.open(IM_TRISTATE).resize((15, 15)), master=self)
